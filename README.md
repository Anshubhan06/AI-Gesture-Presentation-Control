...
Control your Google Slides and microsoft power point presentations using hand gestures through your laptop camera using Computer Vision and AI.
...
```bash
git clone https://github.com/Anshubhan06/gesture-control
cd gesture-control
```
...
5. Uses PyAutoGUI to control Google Slides and microsoft power point presentation
